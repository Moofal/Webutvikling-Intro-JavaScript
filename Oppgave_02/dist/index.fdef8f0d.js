...
})({"If68K":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f1573a76fdef8f0d";
...
},{}],"kPDia":[function(require,module,exports) {
...
function handleSearch() {
    ...
    const userExist = (0, _utilJs.users).find((user)=>user.name === serchedName);
    if (userExist) {
        const fondUser = (0, _utilJs.users).filter((user)=>user.name === serchedName);
        createTable(fondUser);
    } else createTable((0, _utilJs.users));
}
...
function handleFilter() {
    ...
    const userExist = (0, _utilJs.users).find((user)=>user.age > filterAge);
    if (userExist) {
        const fondUser = (0, _utilJs.users).filter((user)=>user.age > filterAge);
        createTable(fondUser);
    } else createTable((0, _utilJs.users));
}
...
},{"./util.js":"cgcsT"}],"cgcsT":[function(require,module,exports) {
...
},{}]},["If68K","kPDia"], "kPDia", "parcelRequire94c2")

//# sourceMappingURL=index.fdef8f0d.js.map
